...
DavidApps Telemetry depends on permissively licensed open-source projects and used other SDKs as API and implementation references. Exact source commits and usage classifications are tracked in `UPSTREAM.yml`.

- Grafana Faro Web SDK — Apache License 2.0 — Copyright Grafana Labs.
- OpenTelemetry JS API 1.9.0/1.9.1, stable SDK 2.10.0, and experimental SDK 0.221.0 — Apache License 2.0 — Copyright The OpenTelemetry Authors.
